...
object BuildProject extends Build {
  ...
  lazy val scalaDemo = Project("scalaDemo", file("scalaDemo")) settings(
    version       := "0.5",
    scalaVersion  := Versions.scala,
  ...
  lazy val lang = Project("Lang", file("lang")) settings(
    ...
    resolvers ++= Seq(
      "Repo1" at "http://maven.aliyun.com/nexus/content/groups/public",
      "Repo2" at "http://oss.sonatype.org/content/repositories/releases",
      "Repo3" at "http://repo1.maven.org/maven2"
    ),
